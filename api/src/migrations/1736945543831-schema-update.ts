...
export class SchemaUpdate1736945543831 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`CREATE TYPE "public"."conclusion_mentalstate_enum" AS ENUM('Anxiety', 'Depression', 'Stress', 'Fear', 'Guilt', 'Shame', 'Anger', 'Hopelessness', 'Isolation', 'Confusion', 'Frustration', 'Insecurity', 'Pessimism', 'Apathy', 'Loneliness')`);
    ...
    await queryRunner.query(`CREATE TYPE "public"."answer_mentalstate_enum" AS ENUM('Anxiety', 'Depression', 'Stress', 'Fear', 'Guilt', 'Shame', 'Anger', 'Hopelessness', 'Isolation', 'Confusion', 'Frustration', 'Insecurity', 'Pessimism', 'Apathy', 'Loneliness')`);
    ...
    await queryRunner.query(`CREATE TYPE "public"."therapy_mentalstates_enum" AS ENUM('Anxiety', 'Depression', 'Stress', 'Fear', 'Guilt', 'Shame', 'Anger', 'Hopelessness', 'Isolation', 'Confusion', 'Frustration', 'Insecurity', 'Pessimism', 'Apathy', 'Loneliness')`);
    ...
    await queryRunner.query(`CREATE TABLE "test_question" ("question_uuid" uuid NOT NULL, "test_uuid" uuid NOT NULL, CONSTRAINT "PK_3e1d90fcf71d8467b34e5d61c01" PRIMARY KEY ("question_uuid", "test_uuid"))`);
